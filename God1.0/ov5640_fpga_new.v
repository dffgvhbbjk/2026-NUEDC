...
//   上电后依次写入    //==================================================================
    localparam REG_NUM = 251;

    reg [23:0] config_rom [0:REG_NUM-1];

    // 完全照搬野火 FPGA 例程 52_ov5640_vga_640x480 的 ov5640_cfg.v (251 寄存器)
    initial begin
        ...
        config_rom[207] = {16'h3008, 8'h02};
        config_rom[208] = {16'h3035, 8'h11};
        config_rom[209] = {16'h3036, 8'h46};
